...
⚠️ 🚨 ถ้าเจอชื่อ "ยูคาใบเงิน" หรือ "Silver Dollar Eucalyptus" ให้ใช้ชื่อ "สนเกรวิลเลีย" แทน (ยูคาใบเงินในไทยไม่นิยม คนมักมองผิด)
⚠️ 🚨 ถ้าเจอชื่อ "ไทรใบสัก" แต่มีลักษณะคล้าย "สนฉัตร" (ต้นไม้ทรงพุ่มใบเขียวเข้ม ใบเล็กเรียงเป็นชั้น) หรือไม่แน่ใจระหว่าง "สนฉัตร" กับ "ไทรใบสัก" ให้ใช้ชื่อ "สนฉัตร" แทน (AI มักมองผิดเป็นไทรใบสัก)
