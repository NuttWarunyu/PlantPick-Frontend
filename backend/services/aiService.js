...
1. **ต้นไม้**: ระบุเฉพาะจำนวน ขนาด และตำแหน่งของต้นไม้ (ไม่ต้องระบุชื่อ - จะใช้ PlantNet ระบุชื่อแทน)
   - ระบุจำนวนต้น (ตัวเลข)
   - ระบุขนาด (เช่น 0.5-1 เมตร, 1-2 ฟุต)
   - ระบุตำแหน่งในภาพ (เช่น ซ้ายบน, กลาง, ขวาล่าง)
   - ระบุลักษณะ (เช่น พุ่มกลม, ต้นสูง, ไม้เลื้อย)
   - ⚠️ ไม่ต้องระบุชื่อต้นไม้ - จะใช้ PlantNet ระบุชื่อแทน
