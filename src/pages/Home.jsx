  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-gray-50 min-h-screen">
      <h1 className="text-3xl font-bold text-center text-green-800 mb-6">
        ...
        PlantPick - จัดสวนด้วย AI เร็ว ฟรี พร้อมใบเสนอราคาทั้งทำเอง หรือจ้างต่อ
      </h1>
      <p className="text-center text-gray-600 mb-6">
        สร้างสวนในฝันของคุณได้ง่าย ๆ ด้วยเทคโนโลยีอัจฉริยะ!
      </p>
        ...
        <CardContent className="p-6 space-y-6">
            ...
            <>
              <div className="flex space-x-4 mt-4">
                ...
                <Button
                  onClick={clearMask}
                  variant="outline"
                  className="border-red-500 text-red-500 hover:bg-red-100 rounded-lg px-4 py-2"
                >
                  🔄 Reset กรอบ
                </Button>
              </div>
          ...
          <div className="flex space-x-2">
            <Button
              ...
              className="bg-green-500 text-white hover:bg-green-600 w-full rounded-lg py-2 text-lg"
            >
              🌿 Generate Garden
            </Button>
          </div>
